...
The Notes backend implements a RESTful HTTP interface and handles the management of notes. It is developed using Node and Express. The purpose is to develop a backend that works with the frontend developed in part 2 of the course.
...
Clone this repository to your own machine with the command git clone https://github.com/fullstack-hy2020/part3-notes-backend.git

Navigate to the cloned repository with the command cd part3-notes-backend
...
If you are on branch part3-4 or later, you need to create a .env file in the root of the project with the following content:
